export const apiDocuments = [
  {
    title: "MDN Web Docs",
    info: "MDN Web Docs 是一个提供 Web 技术和促进 Web 技术软件的不断",
  ...
  {
    title: "Node.js",
    info: "Node.js 是一个基于 Chrome V8 引擎的 JavaScript 运行时。",
    url: "http://nodejs.cn/",
    icon: "nodejs.svg",
  },
];
...
export const frameworks = [
  ...
  {
    title: "Vue CLI",
    info: "🛠️ Vue.js 开发的标准工具",
    url: "https://cli.vuejs.org/zh/",
    icon: "vue.svg",
  },
  {
    title: "Bootstrap",
    info: "简洁、直观、强悍的前端开发框架，让web开发更迅速、简单。",
  ...
  },
  {
    title: "Element-Plus",
    info:
      "网站快速成型工具：Element Plus，一套为开发者、设计师和产品经理准备的基于 Vue 3.0 的桌面端组件库",
...
export const library = [
  {
    title: "jQuery",
    info: "jQuery 是一个“写的更少，但做的更多”的轻量级 JavaScript 库",
...
export const resource = [
  {
    ...
    url: "https://interview.codespring.top/",
  },
  {
    title: "阮一峰的个人网站",
    info: "阮一峰的个人网站",
